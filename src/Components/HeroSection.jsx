            ...
            text-center z-10">
                <div className="space-y-6">
                    <h1 className="text-4xl md-6xl font-bold tracking-tight">
                        ...
                        <span className="text-primary opacity-0 animate-fade-in-delay-1">Asmita</span>
                        <span className="text-gradient ml-2 opacity-0 animate-fade-in-delay-2">{" "}Zope</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-2-2xl
                     mx-auto opacity-0 animate-fade-in-delay-3">
                        ...
                        experience building scalable, enterprise-grade
                        applications using ASP.NET MVC, SQL Server,
                        and modern front-end technologies.
                        I enjoy solving complex problems and
                        delivering clean, reliable, and high-performing solutions. */}
                    </p>
